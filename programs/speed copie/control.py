...
class RobotControl:
    ...
    def __init__(self, flt_front, flt_left, flt_right):
        ...
        self.lineThreshold = 0.75  # line sensor sensitivity
        self.adjThreshold = 0  # adjustment sensitivity -> deactivated here
    ...
    def get_measurements(self, rb):
        ...
        dist_front_flt = self.flt_front.no_spike_mean()

        self.flt_left.add_measure(dist_left)
        dist_left_flt = self.flt_left.no_spike_mean()

        self.flt_right.add_measure(dist_right)
        dist_right_flt = self.flt_right.no_spike_mean()
    ...
    def detect_line(self, rb):
        ...
        return max(rb.get_centerline_sensors()) > self.lineThreshold
    ...
    def follow_line_walled(self, rb):
        ...
        while stage_in_progress:
            ...
            line_detected = max_value > self.lineThreshold
    ...
    def follow_line_turn_left(self, rb):
        ...
        while stage_in_progress:
            ...
            # Prepares for the upcoming follow_walls
